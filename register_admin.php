...
<body>
    ...
    <fieldset>
        ...
        <form method="post">
            ...
            Registration Key:<br><input type="text" name="registration_key" placeholder="Enter Registration Key" required><br><br>
            <input type="submit" value="Register"><br><br>
            <a href="login_admin.php">Already registered? Login here</a><br><br>
        </form>
    </fieldset>
